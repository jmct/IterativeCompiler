...
# set terminal pngcairo  background "#ffffff" fontscale 1.0 size 640, 480 
# set output 'coresSpeedup.png'
unset clip points
set clip one
unset clip two
...
GNUTERM = "qt"
plot 'coreSpeedup.data' using 1:2 with boxes
#    EOF
